...
{
	glm::quat rotation;
	// Define the rotation as the x y z of the axis and the angle (Quaternion = (x, y, z, a)
...
{
	// Add the current orientation by the pitch and yaw.
	_orientation.x += -pitch;
	_orientation.y += -yaw;

	// Update the view to show the rotation.
	updateView();
...
{
	// Add the respectve floats to the axis
	_position += _xaxis * x;
	_position += _yaxis * -y;
...
{
	glm::quat roll;
	// Define the roll quaternion as the axis angle of the current position
	roll = fromAxisAngle(_position, z);
	// Normalize to avoid rounding error
	_orientation = glm::normalize(roll * _orientation);
	// Update the view
	updateView();
...
/////////////////////////////////////////////////////////////////////////////////////////////
// Use to toggle between spotlight and world light
/////////////////////////////////////////////////////////////////////////////////////////////
bool QuatCamera::toggle() 
{
	
	return _lightToggle;
}
void QuatCamera::changetoggle()
{
